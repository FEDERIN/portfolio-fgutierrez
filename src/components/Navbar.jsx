...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-[#121212]/90 backdrop-blur-xl z-50 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-8 py-4 flex justify-between items-center">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-white font-bold tracking-tighter leading-none text-xl">
              FGUTIERREZ
            </span>
        ...
        <div className="hidden md:flex items-center gap-8">
          <ul className="flex gap-8 text-sm font-medium text-gray-400">
            <li>
              <a
                href="#about"
                className="hover:text-[#03DAC6] transition-colors"
              >
                {t("nav.about")}
              </a>
            </li>
      ...
      <div
        className={`${isOpen ? "block" : "hidden"} md:hidden bg-[#1a1a1a] border-b border-white/5 px-8 py-6`}
      >
        <ul className="flex flex-col gap-6 text-sm font-medium text-gray-400 mb-6">
          <li>
            <a
              ...
              className="hover:text-[#03DAC6] block"
            >
              {t("nav.about")}
            </a>
          </li>
