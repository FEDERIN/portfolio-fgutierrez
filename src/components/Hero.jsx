      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="order-1 lg:order-2 space-y-8">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              href="#experience"
              className="bg-[#03DAC6] text-[#121212] px-8 py-4 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:scale-105 transition-all shadow-lg shadow-[#03DAC6]/20"
            >
              {t("hero.btn_exp")}
            </a>
            <a
              href="mailto:federingutierrez@gmail.com"
