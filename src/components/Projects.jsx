...
export default function Projects() {
  ...
  const myProjects = isSpanish ? projectsEs : projectsEn;
  ...
  return (
    <section id="projects" className="py-20 bg-[#121212]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-12">
          <h2 className="text-[#03DAC6] font-mono text-[10px] tracking-[0.3em] uppercase mb-2">Selected Work</h2>
          <h3 className="text-3xl font-black text-white">GitHub <span className="opacity-50">Projects</span></h3>
        </div>
